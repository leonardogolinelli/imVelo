...
def manifold_and_neighbors(adata, n_components, n_knn_search, dataset_name, K, knn_rep, best_key, ve_layer):
    ...
    isomap = Isomap(n_components=n_components, n_neighbors=n_knn_search[0], n_jobs=-1).fit_transform(MuMs)
    print("computing isomap 2..")
    isomap_unique = Isomap(n_components=1, n_neighbors=n_knn_search[0], n_jobs=-1).fit_transform(MuMs)
    ...
    ve_path = f"/mnt/data2/home/leonardo/git/dim_reduction/12_july/embeddings/6layer_{dataset_name}_smooth_K_{ve_layer[0]}.npy"
